...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(15,118,110,0.22),_transparent_30%),radial-gradient(circle_at_85%_10%,_rgba(217,119,6,0.18),_transparent_24%),linear-gradient(180deg,#fcfaf4_0%,#fffdfa_42%,#eef6f3_100%)] text-slate-900">
      <section className="mx-auto max-w-7xl px-4 pb-20 pt-5 sm:px-8 sm:pb-24 sm:pt-8 lg:px-10">
        <div className="inline-flex max-w-full rounded-full border border-white/70 bg-white/60 px-4 py-2 text-center text-[11px] font-semibold tracking-[0.22em] text-teal-900/80 uppercase shadow-sm backdrop-blur sm:text-xs sm:tracking-[0.28em]">
          SOEBAGJO | Optical Customer Database
        </div>

        <div className="mt-8 grid gap-8 lg:mt-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold tracking-[0.24em] text-amber-700 uppercase">
              Dari buku manual ke web app modern
            </p>
            <h1 className="mt-4 max-w-4xl text-4xl leading-[0.98] font-semibold tracking-[-0.05em] text-slate-950 sm:text-6xl lg:text-7xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button
                asChild
                size="lg"
                className="h-12 w-full rounded-full bg-teal-900 px-6 text-sm font-semibold text-white hover:bg-teal-800 sm:w-auto"
              >
                <Link href="/customers">
                  Lihat Data Customer
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-12 w-full rounded-full border-slate-300 bg-white/70 px-6 text-sm font-semibold text-slate-900 backdrop-blur hover:bg-white sm:w-auto"
              >
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-slate-200/80 bg-slate-950 p-4 text-white shadow-[0_24px_80px_rgba(15,23,42,0.25)] sm:rounded-[32px] sm:p-5">
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="mt-4 rounded-2xl bg-white p-4 text-slate-900">
                    ...
                    <div className="mt-4 space-y-3 text-sm">
                      <div className="flex flex-col gap-1 rounded-xl bg-slate-100 px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-8 sm:pb-24 lg:px-10">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-8 sm:py-24 lg:px-10">
        ...
        <div className="mt-10 rounded-[32px] border border-slate-200/80 bg-slate-950 px-5 py-7 text-white shadow-[0_24px_80px_rgba(15,23,42,0.2)] sm:px-8 sm:py-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <Button
              asChild
              size="lg"
              className="h-12 w-full rounded-full bg-white px-6 text-sm font-semibold text-slate-950 hover:bg-slate-100 sm:w-auto"
            >
              <Link href="/customers">
